...
from proxyscrape_sdk.core.helpers import get_ctx_prop, to_map
...
class ProxyscrapeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ProxyscrapeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ProxyscrapeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ProxyscrapeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ProxyscrapeError(code, msg, self)
