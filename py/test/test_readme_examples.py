# Proxyscrape SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ProxyscrapeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ProxyscrapeSDK(...) and ProxyscrapeSDK.test(...) become
#      ProxyscrapeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "proxyscrape_sdk"
_SDK_CLASS = "ProxyscrapeSDK"
