...
func registerSDKWords(r *eng.Registry, client *sdk.ProxyscrapeSDK) {
...
func runOp(client *sdk.ProxyscrapeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
