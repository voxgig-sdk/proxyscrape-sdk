...
// Proxyscrape SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ProxyscrapeSDK::test)
...
{
    private const SDK_CLASS = 'ProxyscrapeSDK';
    ...
    private const SDK_BASE = 'proxyscrape_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../proxyscrape_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
