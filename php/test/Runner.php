...
class ProxyscrapeTestRunner
{
    ...
    {
        $live = self::getenv('PROXYSCRAPE_TEST_LIVE');
        $override = self::getenv('PROXYSCRAPE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PROXYSCRAPE_TEST_EXPLAIN');
...
class_alias('ProxyscrapeTestRunner', 'Runner');
class_alias('ProxyscrapeHelpers', 'Helpers');
