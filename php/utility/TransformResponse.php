...
// Proxyscrape SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ProxyscrapeTransformResponse
{
    public static function call(ProxyscrapeContext $ctx): mixed
    {
        ...
        $transform = ProxyscrapeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
