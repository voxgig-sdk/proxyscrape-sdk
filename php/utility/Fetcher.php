...
// Proxyscrape SDK utility: fetcher

class ProxyscrapeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ProxyscrapeSDK/1.0)';
    ...
    public static function call(ProxyscrapeContext $ctx, string $fullurl, array $fetchdef): array
    {
