...
// Proxyscrape SDK telemetry feature
...
class ProxyscrapeTelemetryFeature extends ProxyscrapeBaseFeature
{
    ...
    private function _close(ProxyscrapeContext $ctx, bool $ok): void
    {
