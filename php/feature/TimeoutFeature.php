...
// Proxyscrape SDK timeout feature
...
class ProxyscrapeTimeoutFeature extends ProxyscrapeBaseFeature
{
    ...
    private function _with_timeout(ProxyscrapeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ProxyscrapeContext $_ctx, float $ms): void
    {
        $client = $this->client;
