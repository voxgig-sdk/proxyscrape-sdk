...
// Proxyscrape SDK ratelimit feature
...
class ProxyscrapeRatelimitFeature extends ProxyscrapeBaseFeature
{
    ...
    private function _acquire(ProxyscrapeContext $ctx): void
    {
    ...
    private function _track(ProxyscrapeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
