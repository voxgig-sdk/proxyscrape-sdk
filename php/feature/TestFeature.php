...
// Proxyscrape SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ProxyscrapeTestFeature extends ProxyscrapeBaseFeature
{
    ...
    public function init(ProxyscrapeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ProxyscrapeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ProxyscrapeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ProxyscrapeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ProxyscrapeContext $ctx, $op, $args): array
    {
