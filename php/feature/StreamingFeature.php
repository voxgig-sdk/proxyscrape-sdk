...
// Proxyscrape SDK streaming feature
...
class ProxyscrapeStreamingFeature extends ProxyscrapeBaseFeature
{
    ...
    private function _iterate(ProxyscrapeResult $result): \Generator
    {
    ...
    private function _streamable(ProxyscrapeContext $ctx): bool
    {
