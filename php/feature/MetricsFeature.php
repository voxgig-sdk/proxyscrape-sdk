...
// Proxyscrape SDK metrics feature
...
class ProxyscrapeMetricsFeature extends ProxyscrapeBaseFeature
{
    ...
    private function _record(ProxyscrapeContext $ctx, bool $ok): void
    {
