...
// Proxyscrape SDK netsim feature
...
class ProxyscrapeNetsimFeature extends ProxyscrapeBaseFeature
{
    ...
    private function _simulate(ProxyscrapeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ProxyscrapeContext $ctx, array $applied): void
    {
        $client = $this->client;
