...
import (
	...
	vs "github.com/voxgig-sdk/proxyscrape-sdk/go/utility/struct"
)

type ProxyListEntity struct {
	name    string
	client  *core.ProxyscrapeSDK
...
func NewProxyListEntity(client *core.ProxyscrapeSDK, entopts map[string]any) *ProxyListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProxyListEntity) GetName() string { return e.name }
...
func (e *ProxyListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProxyListEntity) Deleted() bool {
	return e.deleted
}


func (e *ProxyListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProxyListEntity(e.client, opts)
}

func (e *ProxyListEntity) Data(args ...any) any {
...
func (e *ProxyListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProxyList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProxyListEntity) DataTyped(data ...ProxyList) ProxyList {
	if len(data) > 0 {
		return typedFrom[ProxyList](e.Data(asMap(data[0])))
	}
	return typedFrom[ProxyList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProxyList (all fields
// optional at the wire level).
func (e *ProxyListEntity) MatchTyped(match ...ProxyList) ProxyList {
	if len(match) > 0 {
		return typedFrom[ProxyList](e.Match(asMap(match[0])))
	}
	return typedFrom[ProxyList](e.Match())
}
...
func (e *ProxyListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProxyListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ProxyListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProxyListListMatch and returns []ProxyList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProxyListEntity) ListTyped(reqmatch ProxyListListMatch, ctrl map[string]any) ([]ProxyList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ProxyList](res), nil
}



func (e *ProxyListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProxyListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProxyListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProxyListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
