...
|---|---|---|
| `ts/` | @voxgig-sdk/proxyscrape-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/proxyscrape-sdk \
      --repository voxgig-sdk/proxyscrape-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/proxyscrape-sdk` shows it, and
`npm trust revoke @voxgig-sdk/proxyscrape-sdk --id=<id>` removes it.
