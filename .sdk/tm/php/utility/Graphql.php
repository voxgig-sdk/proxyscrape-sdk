...
// Proxyscrape SDK utility: graphql
//
...
class ProxyscrapeGraphql
{
    ...
    // equivalent.
    public static function body(ProxyscrapeContext $ctx): mixed
    {
    ...
    public static function errors(ProxyscrapeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
