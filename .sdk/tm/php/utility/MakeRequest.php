...
// Proxyscrape SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ProxyscrapeMakeRequest
{
    public static function call(ProxyscrapeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ProxyscrapeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ProxyscrapeResponse($fetched);
        } else {
