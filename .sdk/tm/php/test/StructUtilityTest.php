...
// Proxyscrape SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ProxyscrapeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ProxyscrapeOmni::structfix($now, Struct::undef()))
                        !== json_encode(ProxyscrapeOmni::structfix($val, Struct::undef()))) {
