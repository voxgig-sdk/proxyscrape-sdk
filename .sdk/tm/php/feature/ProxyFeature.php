...
class ProxyscrapeProxyFeature extends ProxyscrapeBaseFeature
{
    ...
    public function init(ProxyscrapeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ProxyscrapeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
