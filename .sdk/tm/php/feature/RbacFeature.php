...
class ProxyscrapeRbacFeature extends ProxyscrapeBaseFeature
{
    ...
    private function _required(ProxyscrapeContext $ctx): ?string
    {
    ...
    private function _reject(ProxyscrapeContext $ctx, string $required): void
    {
    ...
    private function _track(ProxyscrapeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
