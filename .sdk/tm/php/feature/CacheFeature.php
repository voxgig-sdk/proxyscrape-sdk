...
class ProxyscrapeCacheFeature extends ProxyscrapeBaseFeature
{
    ...
    private function _through(ProxyscrapeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
