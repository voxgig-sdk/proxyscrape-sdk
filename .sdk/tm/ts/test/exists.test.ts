...
describe('exists', async () => {
  ...
  //
  // ProxyscrapeSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof ProxyscrapeSDK, true,
      'ProxyscrapeSDK.test() must return a client synchronously')
  })
