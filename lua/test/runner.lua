...
function runner.env_override(m)
  local live = runner.getenv("PROXYSCRAPE_TEST_LIVE")
  local override = runner.getenv("PROXYSCRAPE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PROXYSCRAPE_TEST_EXPLAIN")
