...
describe("ProxyListDirect", function()
  it("should direct-list-proxy_list", function()
    local setup = proxy_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-proxy_list", setup.live and "live" or "unit")
