// Command Proxyscrape-mcp is an MCP server exposing the Proxyscrape
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Proxyscrape_list  — list records of an entity
//	Proxyscrape_load  — load a single record of an entity
//
