...
type Args struct {
	Entity string         `json:"entity" jsonschema:"proxy_list"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ProxyscrapeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "proxyscrape_list",
		Description: "List records from Proxyscrape. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "proxyscrape_load",
		Description: "Load a single record from Proxyscrape. " +
...
func runOp(client *sdk.ProxyscrapeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ProxyscrapeSDK, name string) (sdk.ProxyscrapeEntity, error) {
	switch strings.ToLower(name) {
	case "proxy_list":
		return client.ProxyList(nil), nil
