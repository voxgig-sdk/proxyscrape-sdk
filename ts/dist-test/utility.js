...
function envOverride(m) {
    if ('TRUE' === process.env.PROXYSCRAPE_TEST_LIVE ||
        'TRUE' === process.env.PROXYSCRAPE_TEST_OVERRIDE) {
    ...
    m.PROXYSCRAPE_TEST_EXPLAIN = process.env.PROXYSCRAPE_TEST_EXPLAIN || m.PROXYSCRAPE_TEST_EXPLAIN;
    return m;
}
