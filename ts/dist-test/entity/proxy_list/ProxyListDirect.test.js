...
(0, node_test_1.describe)('ProxyListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ProxyscrapeSDK({
    ...
    (0, node_test_1.test)('direct-list-proxy_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-proxy_list', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            query.request = "displayproxies";
        }
...
function liveScenariosActive() { return false && process.env.PROXYSCRAPE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ProxyscrapeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PROXYSCRAPE_TEST_PROXY_LIST_ENTID'];
    ...
    const client = new __1.ProxyscrapeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ProxyListDirect.test.js.map