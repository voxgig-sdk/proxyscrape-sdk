...
module ProxyscrapeTestRunner
  ...
  def self.env_override(m)
    live = getenv("PROXYSCRAPE_TEST_LIVE")
    override = getenv("PROXYSCRAPE_TEST_OVERRIDE")
    ...
    explain = getenv("PROXYSCRAPE_TEST_EXPLAIN")
    m["PROXYSCRAPE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ProxyscrapeTestRunner
Helpers = ProxyscrapeHelpers
Vs = VoxgigStruct
