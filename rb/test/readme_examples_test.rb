...
#      offline in seeded test mode (ProxyscrapeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Proxyscrape_sdk.rb")
  SDK_CLASS = "ProxyscrapeSDK"
